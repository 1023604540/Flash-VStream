...
deepspeed --master_addr 127.0.2.1 --master_port 12345 --include localhost:${gpus_list} flash_vstream/train/train_mem.py \
    ...
    --version v1 \
    --data_path /anvme/workspace/b232dd16-datasets/finetune/llava_v1_5_mix665k_with_video_chatgpt.json \
    --image_folder /anvme/workspace/b232dd16-datasets/finetune \
    --video_folder /anvme/workspace/b232dd16-datasets/finetune \
    --vision_tower ./ckpt/clip-vit-large-patch14 \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
